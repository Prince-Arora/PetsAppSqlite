...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        String project[] = {PetEntry._ID, PetEntry.COLUMN_PET_NAME, PetEntry.COLUMN_PET_BREED, PetEntry.COLUMN_PET_GENDER, PetEntry.COLUMN_PET_WEIGHT};
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                int weigh=cursor.getInt(weightcolumnindex);
                int gen=cursor.getInt(gendercolumnindex);
                // Display the values from each column of the current row in the cursor in the TextView
                displayView.append(("\n" + currentID + " - " +
                        currentName + " - " + currbreed + " - " + weigh + " - " + gen));
            }
        } finally {
